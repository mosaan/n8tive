...
- **Phase 8: リリース配布とオートアップデート** ✅ 完了 – electron-builder の GitHub Releases 連携を設定。ドラフトリリースを作成し、手動レビュー後に公開できるワークフロー。GH_TOKEN による認証、自動更新用 latest.yml の生成。詳細は `docs/07_ReleaseProcess.md` を参照。
